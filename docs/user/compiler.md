...
| --- | ---: | ---: |
| kernel | 199/410 (48.5%) | 20/30 (66.7%) |
| amsmath | 45/102 (44.1%) | 17/21 (81.0%) |
...
| `\cancel` | `{...}` | parsed to a framed nucleus, but the diagonal strike is not drawn (no render-pipeline strike arm yet): diagnosed, body typeset alone |
| `\bcancel` | `{...}` | parsed to a framed nucleus, but the diagonal strike is not drawn (no render-pipeline strike arm yet): diagnosed, body typeset alone |
| `\xcancel` | `{...}` | parsed to a framed nucleus, but the diagonal strike is not drawn (no render-pipeline strike arm yet): diagnosed, body typeset alone |
...
| `cancel` | `` | \cancel, \bcancel and \xcancel parse to framed nuclei but their diagonal strikes are not drawn yet (no render-pipeline strike arm): diagnosed, body typeset alone; the makeroom and thicklines options change the layout and keep warning |
