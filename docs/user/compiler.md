...
| `\cancel` | `{...}` | diagonal rule over the body: bottom-left to top-right, its mirror, or both |
| `\bcancel` | `{...}` | diagonal rule over the body: bottom-left to top-right, its mirror, or both |
| `\xcancel` | `{...}` | diagonal rule over the body: bottom-left to top-right, its mirror, or both |
