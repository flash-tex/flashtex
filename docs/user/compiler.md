...
| `\nameref` | `*{key}` | hyperref title of the labelled section or caption; other labels fall back to the number; starred form identical, links are not clickable |
