...
| --- | ---: | ---: |
| kernel | 203/410 (49.5%) | 20/30 (66.7%) |
...
| `\labelitemi` |  | article default itemize level-1 marker: \textbullet |
| `\labelitemii` |  | article default itemize level-2 marker: bold \textendash |
| `\labelitemiii` |  | article default itemize level-3 marker: \textasteriskcentered |
| `\labelitemiv` |  | article default itemize level-4 marker: \textperiodcentered |
