...
| `\thispagestyle` | `{style}` | records a one-page style switch: fancy and scrheadings ship the fancyhead/fancyfoot fields, every other style renders no headers or footers |
