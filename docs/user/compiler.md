...
| --- | ---: | ---: |
| kernel | 201/410 (49.0%) | 20/30 (66.7%) |
...
| `csquotes` | `` | \enquote with ``...'' marks (single `...' marks one nesting level down, alternating further in); no locale/babel quote selection, no \enquote* and no package options |
