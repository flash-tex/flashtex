...
| --- | ---: | ---: |
| kernel | 200/410 (48.8%) | 20/30 (66.7%) |
...
| `\addvspace` | `{dimension}` | ends the paragraph and adds fixed vertical space (simplification: consecutive calls add up, real LaTeX keeps the larger) |
