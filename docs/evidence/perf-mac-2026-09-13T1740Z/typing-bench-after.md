# Typing bench: keystroke → paint latency (2026-09-13T175721Z)
...
Script: `tools/typing-bench/run.sh`; raw JSON summaries in `typing-bench-2026-09-13T175721Z/`.
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| render | flashtex-render | body60k | 0 | 30ms | 0 | 0 | 0 | — | — | — | — | 176 | 176 | — | — | 0 | 15 / 25 ⚠ load 25.2 |
| render | flashtex-render | demo | 6113 | 30ms | 200 | 32 | 168 | 460 | 1135 | 1359 | 1568 | 50 | 84 | — | — | 0 | 8.5 / 18 ⚠ load 18.1 |
