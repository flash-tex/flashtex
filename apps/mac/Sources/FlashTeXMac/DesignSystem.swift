...
enum DS {
    ...
    enum Layout {
        ...
        /// Problems panel: header plus two rows at least; the ideal opens a
        /// compact list, never ~1/3 of the minimum window height (audit #76).
        static let problemsMinHeight: CGFloat = 120
        static let problemsIdealHeight: CGFloat = 180
