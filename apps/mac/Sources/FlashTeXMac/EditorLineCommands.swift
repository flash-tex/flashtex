...
/// and selection; the Editor menu and `CompletingTextView` hooks below apply
/// a plan as one undo step. SourceEditorView.swift is left alone (folding
/// lane).
///
...
/// Editor menu, added from `FlashTeXMacApp` with one line.
struct EditorLineCommandMenus: Commands {
