//! Named colour sets, generated by `scripts/color_names.py`; do not edit.
//!
//! - `DVIPS`: dvipsnam.def 2016/06/17 v3.0m Driver-dependent file (DPC,SPQR) (`\DefineNamedColor{named}{..}{cmyk}`),
//!   loaded by xcolor's `dvipsnames` option (and color.sty's).
//! - `SVG`: svgnam.def 2024/09/29 v3.02 Predefined colors according to SVG 1.1 (UK) (`\preparecolorset{rgb}`), xcolor `svgnames`.
//! - `X11`: x11nam.def 2024/09/29 v3.02 Predefined colors according to Unix/X11 (UK) (`\preparecolorset{rgb}`), xcolor `x11names`.
//!
...
/// svgnam.def: `(name, rgb specification)`.
pub(crate) const SVG: &[(&str, &str)] = &[
    ("AliceBlue", ".94,.972,1"),
...
/// x11nam.def: `(name, rgb specification)`.
pub(crate) const X11: &[(&str, &str)] = &[
