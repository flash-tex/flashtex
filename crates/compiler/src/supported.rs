...
const MATH_STRUCTURES: &[(&[&str], &str, &str, bool)] = &[
    ...
    (
        ...
        "",
        "shared symbol glyph with its own atom class (fontmath.ltx's second \\DeclareMathSymbol for the same slot)",
        true,
    ),
    (
        &["smallint"],
        "",
        "small integral at cmsy10's 0.4167em advance (\\int's glyph)",
        true,
    ),
    (
        &["sqrtsign"],
        "{math}",
        "the radical \\sqrt is built on, with no root index",
        true,
    ),
    (
        &["not"],
        "",
        "zero-width negation slash the following relation is overprinted with",
        true,
    ),
    (
        &["mathring"],
        "{math}",
        "ring accent over the argument",
        true,
    ),
    (
        &["injlim", "projlim"],
        "",
        "upright operator name with limits (inj lim / proj lim)",
        true,
    ),
    (
        &["varinjlim", "varprojlim"],
        "",
        "upright lim with an extensible arrow beneath",
        true,
    ),
    (
        &["pod"],
        "{n}",
        "parenthesised (n) after 8mu (18mu in display)",
        true,
    ),
    (
        &["nobreakdash"],
        "",
        "forbids a break after the following dash; sets no glyph",
        true,
    ),
    (
        &["pmb"],
        "{math}",
        "argument at its own advance; the triple overprint is not reproduced",
        false,
    ),
    (
        &[
